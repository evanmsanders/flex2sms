...
<?php echo $this->Form->input('default_not_before', array('timeFormat' => '24', 'interval' => '15', 'class' => 'input-mini')); ?>
<?php echo $this->Form->input('default_not_after', array('timeFormat' => '24', 'interval' => '15', 'class' => 'input-mini')); ?>
